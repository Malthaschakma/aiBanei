...
/**
 * Highlight uses `surface-sunken` rather than the accent token. The accent is
 * a high-luminance lime that only reads correctly as a large filled surface
 * with near-black text, so it is reserved for primary actions.
 */
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "border-border bg-surface text-foreground z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-40 overflow-x-hidden overflow-y-auto rounded-lg border p-1 shadow-lg",
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-muted-foreground tabular ml-auto text-xs tracking-widest",
        className,
      )}
      {...props}
    />
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "focus:bg-surface-sunken data-highlighted:bg-surface-sunken data-[state=open]:bg-surface-sunken",
        "data-inset:pl-8",
        className,
      )}
      {...props}
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "border-border bg-surface text-foreground z-50 min-w-32 overflow-hidden rounded-lg border p-1 shadow-lg",
        "origin-(--radix-dropdown-menu-content-transform-origin)",
